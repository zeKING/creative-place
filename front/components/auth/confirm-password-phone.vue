          ...
          <form @submit.prevent="onSubmit">
            <div class="form_left">
              ...
              <div
                ...
                class="invalid"
              >
                {{ $t("The code must consist of at least 5 characters") }}
              </div>
...
export default {
  ...
  computed: {
    ...mapGetters('profile', ['getPhoneNumber'])
  },
  methods: {
    ...mapActions('profile', ['confirmChangePhone']),
    ...
    async onSubmit () {
      ...
      if (this.$v.$invalid) {
        ...
        try {
          ...
          await this.confirmChangePhone(form)
          this.$emit('close')
        } catch ({ message }) {
          this.$notify(message)
        }
