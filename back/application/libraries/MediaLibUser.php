...
Class MediaLibUser
{
    	...
    	public function save($data)
	{
			...
			foreach ($media_files as $media)
			{
              ...
              //  $data['title']       = (@$data['title']) ? @$data['title'] : "";
               // $data['description'] = (@$data['description']) ? @$data['title'] : "";
                ...
                $data['post_id']     = (@$data['post_id']) ? @$data['post_id'] : 0;
    	...
    	private function _upload2($folder, $type)
	{		
		$config['upload_path']   = './uploads/files/'.$folder;
         $structure = './uploads/files/'.$folder;
         if(!file_exists($structure)){ 
    ...
    public function save2($data, $sub, $type)
	{
		$media_files = $this->_upload2($sub, $type);
