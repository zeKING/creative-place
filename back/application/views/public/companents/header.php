...
<?php if(LANG != 'ru'){?><a href="<?=$link_ru?>" class="dropdown-item">Русский</a><?php }?>
                <?php if(LANG != 'oz'){?><a href="<?=$link_oz?>" class="dropdown-item">O’zbekcha</a><?php }?>
                <?php if(LANG != 'en'){?><a href="<?=$link_en?>" class="dropdown-item">English</a><?php }?>
                <?php if(LANG != 'uz'){?><a href="<?=$link_uz?>" class="dropdown-item">Ўзбекча</a><?php }?>
*/
?>
  <!-- Start of Header -->
        <header class="header">
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown">
                            <a href="#language"><img src="<?=get_resource_url()?>images/tmp/flags/eng.png" alt="ENG Flag" width="14"
                                    height="8" class="dropdown-image" /> ENG</a>
                            <div class="dropdown-box">
                                <a href="#ENG">
                                    <img src="<?=get_resource_url()?>images/tmp/flags/eng.png" alt="ENG Flag" width="14" height="8"
                                        class="dropdown-image" />
                                    ENG
                                </a>
                                <a href="#FRA">
                                    <img src="<?=get_resource_url()?>images/tmp/flags/fra.png" alt="FRA Flag" width="14" height="8"
                                        class="dropdown-image" />
                                    FRA
                                </a>
                            </div>
                        ...
                        <a href="" class="d-lg-show login sign-in"><i class="w-icon-account"></i>Sign In</a>
                ...
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="demo1.html" class="logo ml-lg-0">
                            <img src="<?=get_resource_url()?>images/logo_ashan.png" alt="logo" width="144" height="45" />
                        </a>
                            ...
                            <div class="dropdown-box">
                                ...
                                <div class="products">
                                    <div class="product product-cart">
                                        ...
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="<?=get_resource_url()?>images/tmp/cart/product-1.jpg" alt="product" height="84"
                                                    width="94" />
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product product-cart">
                                        ...
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="<?=get_resource_url()?>images/tmp/cart/product-2.jpg" alt="product" width="84"
                                                    height="94" />
                                            </a>
                                        </figure>
                                        <button class="btn btn-link btn-close" aria-label="button">
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="banner-fixed menu-banner menu-banner2">
                                                        <figure>
                                                            <img src="<?=get_resource_url()?>images/tmp/menu/banner-2.jpg" alt="Menu Banner"
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner3">
                                                        <figure>
                                                            <img src="<?=get_resource_url()?>images/tmp/menu/banner-3.jpg" alt="Menu Banner"
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner4">
                                                        <figure>
                                                            <img src="<?=get_resource_url()?>images/tmp/menu/banner-4.jpg" alt="Menu Banner"
                                                ...
                                                <li class="row">
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="<?=get_resource_url()?>images/tmp/menu/banner-5.jpg" alt="Banner"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="<?=get_resource_url()?>images/tmp/menu/banner-6.jpg" alt="Banner"
                                                                    width="410" height="123"
