 <!-- Start of Footer -->
            ...
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="<?=get_resource_url()?>images/logo_ashan.png" alt="logo-footer" width="144"
                                        height="45" />
                                </a>
                ...
                <div class="footer-bottom">
                    <div class="footer-left">
                        <p class="copyright">&copy; <?=date('Y')?>. <?=lang('copy')?></p>
                    </div>
                    <div class="footer-right">
                      <?=lang('development')?> &nbsp; <a href="https://osg.uz" target="_blank">Online Service Group</a>
                    </div>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
    <?php if(!$user_id2){?>
<? //$this->load->view('public/repetitor/login_reg/login'); ?>
<? //$this->load->view('public/repetitor/login_reg/reg'); ?>
<? //$this->load->view('public/repetitor/login_reg/forgot_password'); ?>
<?php }?>
