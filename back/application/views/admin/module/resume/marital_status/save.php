            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#" onclick="history.go(-1)"> Семейное положение</a>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane  fade <?=($i==1) ? 'show active' : ''?>" id="tab<?= $i ?>">
            <div class="form-group">
                ...
                <div class="controls">
                    <input name="title[<?= $key ?>]" class="form-control input-xlarge focused" type="text" value="<?= set_value('title[' . $key . ']', _t(@$post->title, $key)) ?>">
                </div>
            </div>
...
<div class="form-group" style="display: none;">
    ...
    <div class="controls">
        <input <?php if (!$post->alias) { ?>id="alias" <?php } ?> name="alias" class=" form-control form-control span3" type="text" value="<?= set_value('alias', $post->id) ?>">
    </div>
</div>
