        ...
        <? $i=1; foreach ($settings['languages']->value as $key => $val): ?>
            <div class="tab-pane  fade <?=($i==1) ? 'show active' : ''?>" id="tab<?= $i ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input name="category_title[<?= $key ?>]" class="form-control input-xlarge" type="text" value="<?= set_value('category_title[' . $key . ']', _t(@$post->category_title, $key)) ?>">
                    </div>
                </div>
...
<div class="form-group">
    ...
    <div class="controls">
        <input name="option_2" class="form-control input-xlarge" type="text" value="<?= set_value('option_2', @$post->option_2) ?>">
    </div>
</div>
<div class="form-group">
    <label class="control-label" for="focusedInput">Карта</label>
    <div class="controls">
        <input name="option_3" class="form-control input-xlarge" type="text" value="<?= set_value('option_3', @$post->option_3) ?>">
    </div>
</div>
