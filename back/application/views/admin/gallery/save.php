            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#" onclick="history.go(-1)"> Галерея</a>
                        </li>
                    </ol>
                </div>
            </div>
...
<div class="form-group">
    ...
    <div class="controls">
        <a href="#myModal" role="button" class="btn btn-info" data-toggle="modal"><i class="icon-file icon-white"></i> Картинки</a>
    </div>
</div>
