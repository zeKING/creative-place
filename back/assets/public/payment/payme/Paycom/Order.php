...
class Order extends Database
{
    ...
    public function find($params)
    {
        ...
        if (isset($params['order_id'])) {
            ...
            $sql        = "select * from cart_u where id=:orderId";
            $sth        = self::db()->prepare($sql);
            $is_success = $sth->execute(Array(':orderId' => $params['order_id']));
    ...
    public function save()
    {
        ...
        if (!$this->id) {
            ...
            $sql        = "insert into cart_u set product_ids = :pProdIds, amount = :pAmount, state = :pState, user_id = :pUserId, phone = :pPhone";
            $sth        = $db->prepare($sql);
            ...
            $sql        = "update cart_u set state = :pState where id = :pId";
            $sth        = $db->prepare($sql);
            $is_success = $sth->execute(Array(':pState' => $this->state, ':pId' => $this->id));
