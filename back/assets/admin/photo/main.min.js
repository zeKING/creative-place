        ...
        o = {
            ...
            subscribe: function(t, e, i) {
                for (var n, o = this._setEntry(t, "subscriptions"), r = 0, s = o.subscriptions, a = s.length; r < a; r++)
                    if (n = s[r], n.type === e && n.fn === i) return;
                s.push({
                    type: e,
                    fn: i
                })
            ...
            publish: function(t, e, i) {
                ...
                if (u && (u.length || a.length) || this._clearEntry(t), u)
                    for (h = u.length, s = 0; s < h; s++) this.publish(u[s], e, i)
            },
            inform: function(t, e) {
                if (!t || !e) return !1;
            ...
            conceal: function(t, e) {
                ...
                if (!i) return !1;
                for (var n, o = i.length, r = !1; --o >= 0;) n = i[o], n === e && (i.splice(o, 1), r = !0);
...
function(t, e) {
    ...
    var i = function(e, i, n, o, r, s) {
        ...
        l.prototype = {
            ...
            isTrue: function() {
                for (var t = 0, e = this._count; e > t; t++)
                    if (!this._watches[t].valid) return !1;
                return !0
            },
                ...
                return a.loader.require([a.paths.monitors + o], function(n) {
                    ...
                    if (!m) {
                        if (m = {
                            ...
                            }(p)), "function" == typeof n.trigger) n.trigger(m.change, p);
                        else
                            for (c in n.trigger) n.trigger.hasOwnProperty(c) && n.trigger[c].addEventListener(c, m.change, !1);
                        s._db[g] = m
                    }
                    ...
                    parse: function(i) {
                        ...
                        for (b || (b = g); S > _; _++)
                            if (h = i.charCodeAt(_), 123 !== h)
                                if (125 === h && (n = b.length - 1, o = n + 1, y = "not" === b[n], o = y ? n : n + 1, s = new l(m, v), b[o] = new t(s, y), m = "", v = "", y = !1, w = !1), w) v += i.charAt(_);
                                else {
                                    if (40 === h && (b.push([]), k.push(b), b = b[b.length - 1]), 32 === h || 0 === _ || 40 === h) {
                                        if (r = i.substr(_, 5).match(/and |or |not /g), !r) continue;
                                        d = r[0], p = d.length - 1, b.push(d.substring(0, p)), _ += p
                                    }
                                    if (41 === h || _ === S - 1)
                                        do
                                            if (x = k.pop(), 0 !== b.length) {
                                            ...
                                            } else b = x; while (_ === S - 1 && x)
                                }
                        else
                            for (w = !0, m = "", u = _ - 2; u >= 0 && (c = i.charCodeAt(u), 32 !== c && 40 !== c);) m = i.charAt(u) + m, u--;
        ...
        b.prototype = {
            ...
            _overrideObjectWithUri: function(t, e) {
                for (var i, n = t, o = "", r = 0, s = e.length; s > r;) {
                    if (i = e.charCodeAt(r), 46 != i && 58 != i) o += e.charAt(r);
                    else {
                        if (58 == i) {
            ...
            _parseOptions: function(t, e, i) {
                ...
                do n = w.getModule(t), r.push({
                    page: n,
                    module: e.options
                }), t = e.__superUrl; while (e = e.__super);
        ...
        k.prototype = {
            destroy: function() {
                for (var t, e = 0, n = this._controllers.length; n > e; e++) t = this._controllers[e], t && (i.unsubscribe(t, "load", this._controllerLoadedBind), i.unsubscribe(t, "unload", this._controllerUnloadedBind));
            ...
            areAllModulesActive: function() {
                for (var t, e = 0, i = this._controllers.length; i > e; e++)
                    if (t = this._controllers[e], !this._isActiveController(t)) return !1;
                return !0
            },
            _onLoad: function() {
                this._test()
        ...
        return E.prototype = {
            parse: function(t) {
                var e, i, n = t.querySelectorAll("[data-module]"),
                    o = n.length,
                    r = 0,
                    s = [];
                if (!n) return [];
            ...
            getNodeByElement: function(t) {
                for (var e, i = 0, n = this._nodes.length; n > i; i++)
                    if (e = this._nodes[i], e.getElement() === t) return e;
                return null
            },
            getNodes: function(t, e, i) {
                if ("undefined" == typeof t && "undefined" == typeof e) return i ? this._nodes[0] : this._nodes.concat();
            ...
            destroy: function(t) {
                for (var e, i = t.length, n = 0; i--;) e = this._nodes.indexOf(t[i]), -1 !== e && (this._nodes.splice(e, 1), t[i].destroy(), n++);
                return t.length === n
            },
            _getModuleControllersByElement: function(t) {
                ...
                if (91 == e.charCodeAt(0)) {
                    ...
                    for (; i > s; s++) o = n[s], w.isModuleEnabled("string" == typeof o ? o : o[0]) && ("string" == typeof o ? r[s] = this._getModuleController(o, t) : r[s] = this._getModuleController(o[0], t, "string" == typeof o[1] ? o[2] : o[1], "string" == typeof o[1] ? o[1] : o[2]));
                    return r
                }
    ...
    function(t, e) {
        "use strict";
        var i = !!sessionStorage.getItem("activeSession"),
            n = parseInt(localStorage.getItem("totalVisits") || 0, 10);
        i || n++, sessionStorage.setItem("activeSession", !0), localStorage.setItem("totalVisits", n);
        var o = 1 === n,
            r = {
                trigger: {
                    load: t
                ...
                test: {
                    ...
                    "min-count": function(t) {
                        return parseInt(t.expected, 10) <= n
                    },
                    "max-count": function(t) {
                        return parseInt(t.expected, 10) >= n
                    },
                    current: function(t) {
                        return parseInt(t.expected, 10) === n
        ...
        "undefined" != typeof module && module.exports ? module.exports = r : "function" == typeof define && define.amd && define("monitors/session", [], function() {
            return r
        })
    }(this),
    function(t, e) {
        ...
        function e(t, e) {
            if (!(e >= 1)) {
                for (var i = t.width * e, n = t.height * e, o = t.width, r = t.height, s = t; o > i && r > n;) {
                    var a = document.createElement("canvas");
                    o = .5 * s.width, r = .5 * s.height, o < i && (o = i), r < n && (r = n), a.width = o, a.height = r;
                    var h = a.getContext("2d");
                    h.drawImage(s, 0, 0, o, r), s = ot(a)
                }
                t.width = i, t.height = n;
                var h = t.getContext("2d");
                h.drawImage(s, 0, 0, i, n)
            }
        }! function() {
            function t(t, e) {
                e = e || {
        ...
        var i = function(t, e, n) {
                ...
                if (s.onerror = e, s.onload = function() {
                    ...
                    }, i.isInstanceOf("Blob", t) || i.isInstanceOf("File", t)) o = r = i.createObjectURL(t), s._type = t.type;
                else {
        ...
        i.isInstanceOf = function(t, e) {
            ...
            if (g && (e = i.getTransformedOptions(t, e), c = e.left || 0, d = e.top || 0, e.sourceWidth ? (u = e.sourceWidth, void 0 !== e.right && void 0 === e.left && (c = v - u - e.right)) : u = v - c - (e.right || 0), e.sourceHeight ? (l = e.sourceHeight, void 0 !== e.bottom && void 0 === e.top && (d = y - l - e.bottom)) : l = y - d - (e.bottom || 0), w = u, b = l), r = e.maxWidth, s = e.maxHeight, a = e.minWidth, h = e.minHeight, g && r && s && e.crop ? (w = r, b = s, _ = u / l - r / s, _ < 0 ? (l = s * u / r, void 0 === e.top && void 0 === e.bottom && (d = (y - l) / 2)) : _ > 0 && (u = r * l / s, void 0 === e.left && void 0 === e.right && (c = (v - u) / 2))) : ((e.contain || e.cover) && (a = r = r || a, h = s = s || h), e.cover ? (o(), n()) : (n(), o())), g) {
                if (p = e.pixelRatio, p > 1 && (m.style.width = w + "px", m.style.height = b + "px", w *= p, b *= p, m.getContext("2d").scale(p, p)), f = e.downsamplingRatio, f > 0 && f < 1 && w < u && b < l)
                    for (; u * f > w;) m.width = u * f, m.height = l * f, i.renderImageToCanvas(m, t, c, d, u, l, 0, 0, m.width, m.height), u = m.width, l = m.height, t = document.createElement("canvas"), t.width = u, t.height = l, i.renderImageToCanvas(t, m, 0, 0, u, l, 0, 0, u, l);
        ...
        i.blobSlice = a && function() {
                ...
                if (65496 === c.getUint16(0)) {
                    for (; d < p && (r = c.getUint16(d), r >= 65504 && r <= 65519 || 65534 === r) && (a = c.getUint16(d + 2) + 2, !(d + a > c.byteLength));) {
                        if (h = i.metaDataParsers.jpeg[r])
                            for (u = 0; u < h.length; u += 1) h[u].call(o, c, d, a, s, n);
                        d += a, f = d
            ...
            if (p && (a = p.size * r, h = a > 4 ? e + t.getUint32(n + 8, s) : n + 8, !(h + a > t.byteLength))) {
                ...
                if (p.ascii) {
                    for (c = "", l = 0; l < u.length && (d = u[l], "\0" !== d); l += 1) c += d;
                    return c
                }
                return u
            }
            ...
            if (!r.disableExif) {
                ...
                if (1165519206 === t.getUint32(e + 4) && !(u + 8 > t.byteLength) && 0 === t.getUint16(e + 8)) {
                    ...
                    42 === t.getUint16(u + 2, s) && (a = t.getUint32(u + 4, s),
                        o.exif = new i.ExifMap, a = i.parseExifTags(t, u, u + a, s, o), a && !r.disableExifThumbnail && (h = {
                            exif: {}
        ...
        var h = function() {
                ...
                var s = function(t, e, i) {
                        ...
                        if (void 0 !== n.length) {
                            for (var o = {
                                ...
                                }, r = 0, s = n.length; r < s; ++r) "string" == typeof e ? o.chainers.push(h(n[r], e, a(i, r, s))) : o.chainers.push(h(n[r], a(e, r, s), i));
                            return o
                        }
                    ...
                    h = function(t, i, n) {
                        function o(i) {
                            if (f.tick(i), f.updateElement(t), !f.isStopped()) return f.completed() ? void(r.loop > 1 && !f.isStopped() ? (r.loop -= 1, f.restart(), b(o)) : (r.complete && r.complete.call(t), m.length && (r = m.pop(), h = v(r, c, !0), c = v(r, J(c)), r = y(h, c, r), f = k(r), e.push([t, f]), f.tick(i), b(o)))) : b(o)
                        }
                        if ("attention" === i) return u(t, n);
                        if ("stop" === i) return l(t);
                        if ("detach" === i) return d(t);
                        var r = i;
                        _();
                        var s = g(t),
                            h = s;
                    ...
                    d = function(t) {
                        ...
                        for (a = r.length, o = 0; o < a; ++o) p(r[o])
                    },
                    p = function(t) {
                        l(t);
                        var n = c(e, t);
                    ...
                    k = function(t) {
                        ...
                        var h, u, l = 0,
                            ...
                            _ = 0,
                            m = o / n;
                        return u = t.valueFeeder ? j(t.valueFeeder, e, i, a) : q(e, i, a), {
                            stop: function() {
                                d = !0
                            },
                            isStopped: function() {
            ...
            u = function() {
                ...
                function i(t, e, i, s, a, h) {
                    var u, l, c, d, p, f, _, m, g, v, y, w, b, x, k, S, E, C, M, T, A, P, I, O, L = t.data,
                        D = h + h + 1,
                        R = s - 1,
                        z = a - 1,
                        B = h + 1,
                    ...
                    var j = o[h],
                        V = r[h];
                    for (l = 0; l < a; l++) {
                        for (S = E = C = M = m = g = v = y = 0, w = B * (T = L[f]), b = B * (A = L[f + 1]), x = B * (P = L[f + 2]), k = B * (I = L[f + 3]), m += U * T, g += U * A, v += U * P, y += U * I, H = N, c = 0; c < B; c++) H.r = T, H.g = A, H.b = P, H.a = I, H = H.next;
                        for (c = 1; c < B; c++) d = f + ((R < c ? R : c) << 2), m += (H.r = T = L[d]) * (O = B - c), g += (H.g = A = L[d + 1]) * O, v += (H.b = P = L[d + 2]) * O, y += (H.a = I = L[d + 3]) * O, S += T, E += A, C += P, M += I, H = H.next;
                        for (W = N, q = F, u = 0; u < s; u++) L[f + 3] = I = y * j >> V, 0 != I ? (I = 255 / I, L[f] = (m * j >> V) * I, L[f + 1] = (g * j >> V) * I, L[f + 2] = (v * j >> V) * I) : L[f] = L[f + 1] = L[f + 2] = 0, m -= w, g -= b, v -= x, y -= k, w -= W.r, b -= W.g, x -= W.b, k -= W.a, d = _ + ((d = u + h + 1) < R ? d : R) << 2, S += W.r = L[d], E += W.g = L[d + 1], C += W.b = L[d + 2], M += W.a = L[d + 3], m += S, g += E, v += C, y += M, W = W.next, w += T = q.r, b += A = q.g, x += P = q.b, k += I = q.a, S -= T, E -= A, C -= P, M -= I, q = q.next, f += 4;
                        _ += s
                    }
                    for (u = 0; u < s; u++) {
                        for (E = C = M = S = g = v = y = m = 0, f = u << 2, w = B * (T = L[f]), b = B * (A = L[f + 1]), x = B * (P = L[f + 2]), k = B * (I = L[f + 3]), m += U * T, g += U * A, v += U * P, y += U * I, H = N, c = 0; c < B; c++) H.r = T, H.g = A, H.b = P, H.a = I, H = H.next;
                        for (p = s, c = 1; c <= h; c++) f = p + u << 2, m += (H.r = T = L[f]) * (O = B - c), g += (H.g = A = L[f + 1]) * O, v += (H.b = P = L[f + 2]) * O, y += (H.a = I = L[f + 3]) * O, S += T, E += A, C += P, M += I, H = H.next, c < z && (p += s);
                        for (f = u, W = N, q = F, l = 0; l < a; l++) d = f << 2, L[d + 3] = I = y * j >> V, I > 0 ? (I = 255 / I, L[d] = (m * j >> V) * I, L[d + 1] = (g * j >> V) * I, L[d + 2] = (v * j >> V) * I) : L[d] = L[d + 1] = L[d + 2] = 0, m -= w, g -= b, v -= x, y -= k, w -= W.r, b -= W.g, x -= W.b, k -= W.a, d = u + ((d = l + B) < z ? d : z) * s << 2, m += S += W.r = L[d], g += E += W.g = L[d + 1], v += C += W.b = L[d + 2], y += M += W.a = L[d + 3], W = W.next, w += T = q.r, b += A = q.g, x += P = q.b, k += I = q.a, S -= T, E -= A, C -= P, M -= I, q = q.next, f += s
                    }
                    return t
                }
        ...
        var l = function() {
            ...
            d = function(t) {
                if ("undefined" == typeof t.dataset) {
                    var e, i, n = {},
                        o = t.attributes;
                    for (e in o) o.hasOwnProperty(e) && o[e].name && /^data-[a-z_\-\d]*$/i.test(o[e].name) && (i = p(o[e].name.substr(5)), n[i] = o[e].value);
                    return n
                }
                return t.dataset
            },
            ...
            O = function(t, e, i, n, o, r) {
                ...
                n && s.upload.addEventListener("progress", function(t) {
                    n(t.loaded, t.total)
                }), s.open("POST", t, !0), i && i(s), s.onreadystatechange = function() {
                    if (4 === s.readyState && s.status >= 200 && s.status < 300) {
                        ...
                        if ("object" === ("undefined" == typeof e ? "undefined" : c(e)) && "failure" === e.status) return void r(e.message);
                        o(e || t)
                        ...
                        if ("object" === ("undefined" == typeof i ? "undefined" : c(i)) && "failure" === i.status) return void r(i.message);
                        r("fail")
                    }
                }, s.send(e)
            },
            ...
            U = function(t) {
                var e = void 0;
                for (e in y)
                    if (y.hasOwnProperty(e) && t.indexOf(y[e]) !== -1) return y[e];
                return null
            },
            N = function(t) {
            ...
            W = function(t) {
                return "undefined" == typeof t.name ? F(new Date) + "." + B(q(t)) : t.name
            },
            q = function(t) {
                return t.type || "image/jpeg"
            },
            j = function(t) {
                if ("string" != typeof t) return F(new Date);
                var e = N(t);
            ...
            J = function(t, e) {
                for (var i = Y(t), n = new ArrayBuffer(i.length), o = new Uint8Array(n), r = 0; r < i.length; r++) o[r] = i.charCodeAt(r);
                var s = gt(t);
                return "undefined" == typeof e && (e = F(new Date) + "." + B(s)), V(new Blob([n], {
                    type: s
                }), e)
            },
            $ = function(t, e, n) {
            ...
            K = function(t) {
                ...
                if (s) {
                    var u = r % 180 !== 0,
                        ...
                        p = s.width / l.width,
                        f = s.height / l.height;
                    s.y + s.height > l.height && (s.y = Math.max(0, l.height - s.height)), s.x + s.width > l.width && (s.x = Math.max(0, l.width - s.width)), o.width = s.width, o.height = s.height;
                    var _ = o.getContext("2d");
                    90 === r ? (_.translate(.5 * o.width, .5 * o.height), _.rotate(-90 * Math.PI / 180), _.drawImage(t, (1 - d) * t.width - t.width * f, s.x, s.height, s.width, .5 * -o.height, .5 * -o.width, o.height, o.width)) : 180 === r ? (_.translate(.5 * o.width, .5 * o.height), _.rotate(-180 * Math.PI / 180), _.drawImage(t, (1 - (c + p)) * l.width, (1 - (d + f)) * l.height, p * l.width, f * l.height, .5 * -o.width, .5 * -o.height, o.width, o.height)) : 270 === r ? (_.translate(.5 * o.width, .5 * o.height), _.rotate(-270 * Math.PI / 180), _.drawImage(t, s.y, (1 - c) * t.height - t.height * p, s.height, s.width, .5 * -o.height, .5 * -o.width, o.height, o.width)) : _.drawImage(t, s.x, s.y, s.width, s.height, 0, 0, o.width, o.height)
                }
                if (a) {
                    var m = a.width / o.width,
                        g = a.height / o.height,
                        v = Math.min(m, g);
                    e(o, v), h.sharpen > 0 && tt(o, it(h.sharpen))
                }
                n(o)
            },
            Q = function(t) {
            ...
            tt = function(t, e) {
                ...
                i.putImageData(e(Q(t), t.width, t.height), 0, 0)
            },
            et = function(t, e, i) {
            ...
            it = function(t) {
                return function(e, i, n) {
                    for (var o = [0, -1, 0, -1, 5, -1, 0, -1, 0], r = Math.round(Math.sqrt(o.length)), s = .5 * r | 0, a = et(i, n), h = a.data, u = e.data, l = n, c = void 0; l--;)
                        for (c = i; c--;) {
            ...
            rt = function(t, i) {
                ...
                var n = document.createElement("canvas"),
                    o = n.getContext("2d");
                return n.width = t.width, n.height = t.height, o.drawImage(t, 0, 0), i > 0 && 1 != i && e(n, i), n
            },
            st = function(t) {
            ...
            at = function(t, e) {
                ...
                st(e) ? i.drawImage(t, 0, 0, e.width, e.height) : (e.width = t.width, e.height = t.height, i.drawImage(t, 0, 0))
            },
            ht = function(t) {
            ...
            ft = function(t) {
                ...
                return i.name = t.name, t.lastModifiedDate && (i.lastModifiedDate = new Date(t.lastModifiedDate)), i
            },
            _t = function(t) {
                var e = pt(t);
                return e.input.file = ft(t.input.file), e.output.image = ot(t.output.image), e
            },
            mt = function(t, e, i) {
            ...
            vt = function(t) {
                ...
                return I("output", e) && (o.output = {
                    name: n ? j(t.input.name) + "." + n : t.input.name,
                    type: y[n] || t.input.type,
                    width: t.output.width,
                    height: t.output.height
                }, o.output.image = mt(t.output.image, o.output.type, i), o.output.type = gt(o.output.image), "image/png" === o.output.type && (o.output.name = j(o.input.name) + ".png")), I("actions", e) && (o.actions = pt(t.actions)), o
            },
            yt = function(t, e, i) {
            ...
            Ct = function(t, e, i, n) {
                return Et(t, e, i, 0, 360 * n)
            },
            Mt = function() {
                var e = {
                    n: function(t, e, i, n) {
                        var o, r, s, a, h, u, l, c;
                        return s = t.y + t.height, o = P(e.y, 0, s), s - o < i.min.height && (o = s - i.min.height), h = n ? (s - o) / n : t.width, h < i.min.width && (h = i.min.width, o = s - h * n), l = .5 * (h - t.width), a = t.x - l, r = t.x + t.width + l, (a < 0 || r > i.width) && (c = Math.min(t.x, i.width - (t.x + t.width)), a = t.x - c, r = t.x + t.width + c, h = r - a, u = h * n, o = s - u), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                    ...
                    s: function(t, e, i, n) {
                        var o, r, s, a, h, u, l, c;
                        return o = t.y, s = P(e.y, o, i.height), s - o < i.min.height && (s = o + i.min.height), h = n ? (s - o) / n : t.width, h < i.min.width && (h = i.min.width, s = o + h * n), l = .5 * (h - t.width), a = t.x - l, r = t.x + t.width + l, (a < 0 || r > i.width) && (c = Math.min(t.x, i.width - (t.x + t.width)), a = t.x - c, r = t.x + t.width + c, h = r - a, u = h * n, s = o + u), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                    ...
                    e: function(t, e, i, n) {
                        var o, r, s, a, h, u, l, c;
                        return a = t.x, r = P(e.x, a, i.width), r - a < i.min.width && (r = a + i.min.width), u = n ? (r - a) * n : t.height, u < i.min.height && (u = i.min.height, r = a + u / n), l = .5 * (u - t.height), o = t.y - l, s = t.y + t.height + l, (o < 0 || s > i.height) && (c = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - c, s = t.y + t.height + c, u = s - o, h = u / n, r = a + h), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                    ...
                    w: function t(e, i, n, o) {
                        var r, s, a, h, t, u, l, c;
                        return s = e.x + e.width, h = P(i.x, 0, s), s - h < n.min.width && (h = s - n.min.width), u = o ? (s - h) * o : e.height, u < n.min.height && (u = n.min.height, h = s - u / o), l = .5 * (u - e.height), r = e.y - l, a = e.y + e.height + l, (r < 0 || a > n.height) && (c = Math.min(e.y, n.height - (e.y + e.height)), r = e.y - c, a = e.y + e.height + c, u = a - r, t = u / o, h = s - t), {
                            x: h,
                            y: r,
                            width: s - h,
                            height: a - r
                    ...
                    ne: function(t, e, i, n) {
                        var o, r, s, a, h, u, l;
                        return a = t.x, s = t.y + t.height, r = P(e.x, a, i.width), r - a < i.min.width && (r = a + i.min.width), u = n ? (r - a) * n : P(s - e.y, i.min.height, s), u < i.min.height && (u = i.min.height, r = a + u / n), o = t.y - (u - t.height), (o < 0 || s > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = s - o, h = u / n, r = a + h), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                    ...
                    se: function(t, e, i, n) {
                        var o, r, s, a, h, u, l;
                        return a = t.x, o = t.y, r = P(e.x, a, i.width), r - a < i.min.width && (r = a + i.min.width), u = n ? (r - a) * n : P(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, r = a + u / n), s = t.y + t.height + (u - t.height), (o < 0 || s > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), s = t.y + t.height + l, u = s - o, h = u / n, r = a + h), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                    ...
                    sw: function(t, e, i, n) {
                        var o, r, s, a, h, u, l;
                        return r = t.x + t.width, o = t.y, a = P(e.x, 0, r), r - a < i.min.width && (a = r - i.min.width), u = n ? (r - a) * n : P(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, a = r - u / n), s = t.y + t.height + (u - t.height), (o < 0 || s > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), s = t.y + t.height + l, u = s - o, h = u / n, a = r - h), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                    ...
                    nw: function(t, e, i, n) {
                        var o, r, s, a, h, u, l;
                        return r = t.x + t.width, s = t.y + t.height, a = P(e.x, 0, r), r - a < i.min.width && (a = r - i.min.width), u = n ? (r - a) * n : P(s - e.y, i.min.height, s), u < i.min.height && (u = i.min.height, a = r - u / n), o = t.y - (u - t.height), (o < 0 || s > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = s - o, h = u / n, a = r - h), {
                            x: a,
                            y: o,
                            width: r - a,
                            height: s - o
                ...
                return function() {
                    ...
                    return l(i, [{
                        ...
                        value: function(t, e, i, n) {
                            this._interaction = null, this._rect = {
                                x: P(t, 0, this._space.width - this._minWidth),
                                y: P(e, 0, this._space.height - this._minHeight),
                                width: P(i, this._minWidth, this._space.width),
                                height: P(n, this._minHeight, this._space.height)
                            }, this._rectChanged = !0, this._redraw(), this._element.dispatchEvent(new CustomEvent("change"))
                        }
                    }, {
                        key: "handleEvent",
                        ...
                        value: function(t) {
                            ...
                            "c" === n ? (this._rect.x = P(i.x - this._interaction.offset.x, 0, this._space.width - this._rect.width), this._rect.y = P(i.y - this._interaction.offset.y, 0, this._space.height - this._rect.height)) : e[n] && (this._rect = e[n](this._rect, {
                                x: i.x - this._space.x,
                                y: i.y - this._space.y
                            }, {
                                x: 0,
                        ...
                        key: "destroy",
                        value: function() {
                            this._interaction = !1, this._rectChanged = !1, k(document, v.DOWN, this), k(document, v.MOVE, this), k(document, v.UP, this), xt(this._element)
                        }
                    }, {
                        key: "element",
                        get: function() {
                ...
                var e = ["input", "change"],
                    i = function() {
                        ...
                        return l(i, [{
                            ...
                            value: function() {
                                var t = this;
                                this._element.className = "slim-image-editor", this._container = b("div", "slim-container"), this._wrapper = b("div", "slim-wrapper"), this._stage = b("div", "slim-stage"), this._container.appendChild(this._stage), this._cropper = new Mt, e.forEach(function(e) {
                            ...
                            value: function() {
                                var t = this._wrapperRotation % 180 !== 0,
                                    ...
                                    i = lt(e, t ? this._input.height : this._input.width, t ? this._input.width : this._input.height);
                            ...
                            value: function() {
                                ...
                                e && E(e, 90), this._updateWrapperScale(), this._hideCropper(), h(this._previewWrapper, {
                            ...
                            value: function(t, e, i, n, o) {
                                ...
                                var s = n % 180 !== 0,
                                    a = ct(i, s ? t.height : t.width, s ? t.width : t.height);
                                this._preview.onload = function() {
                                    r._preview.onload = null, r._cropper.ratio = r.ratio, r._redraw(), r._redrawCropper(a), o(), r._element.style.opacity = ""
                                }, this._preview.src = rt(this._input, Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height)).toDataURL()
                            }
                        }, {
                            key: "_redrawCropper",
                            value: function(t) {
                                ...
                                c = t ? {
                                    ...
                                    width: t.width * a,
                                    height: t.height * h
                                } : Z(a, h, this._ratio || h / a), this._cropper.resize(c.x, c.y, c.width, c.height)
                            }
                        }, {
                            key: "_redraw",
                            value: function() {
                                ...
                                this._wrapper.style.cssText = "\n\t\t\t\tleft:" + r + "px;\n\t\t\t\ttop:" + s + "px;\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewBlurred.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._preview.style.cssText = "\n\t\t\t\twidth:" + n + "px;\n\t\t\t\theight:" + o + "px;\n\t\t\t", this._previewSize = {
                                    width: n,
                                    height: o
                                }, this._blurredPreview || (this._previewBlurred.width = 300, this._previewBlurred.height = this._previewBlurred.width * t, at(this._input, this._previewBlurred), ht(this._previewBlurred, 3), this._blurredPreview = !0)
                            }
                        }, {
                            key: "show",
                            value: function() {
                            ...
                            value: function() {
                                var t = this;
                                bt(this._btnGroup.children).forEach(function(e) {
                                    e.removeEventListener("click", t)
                                }), e.forEach(function(e) {
                                    t._cropper.element.removeEventListener(e, t)
                                }), this._cropper.destroy(), this._element.parentNode && xt(this._element)
                            }
                        }, {
            ...
            At = function() {
                var e = ["dragover", "dragleave", "drop"];
                return function() {
                    function i() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document.createElement("div");
                        t(this, i), this._element = e, this._accept = [], this._dragPath = null, this._init()
                    }
                    return l(i, [{
                        key: "isValidDataTransfer",
                        value: function(t) {
                            return t.files.length ? this.areValidDataTransferFiles(t.files) : this.areValidDataTransferItems(t.items)
                        }
                    }, {
                        ...
                        value: function(t) {
                            return !this._accept.length || !t || (t[0].type && 0 === t[0].type.indexOf("application") ? null : this._accept.indexOf(t[0].type) !== -1)
                        }
                    }, {
                        key: "reset",
                        value: function() {
                        ...
                        value: function(t) {
                            ...
                            return e ? (this._element.files = t.dataTransfer.files, this._element.dispatchEvent(new CustomEvent("file-drop", {
                                detail: _(t)
                        ...
                        value: function(t) {
                            ...
                            return null === e || e ? (this._dragPath || (this._dragPath = []), this._dragPath.push(_(t)), void this._element.dispatchEvent(new CustomEvent("file-over", {
                                detail: {
                                    x: A(this._dragPath).x,
                                    y: A(this._dragPath).y
                                }
                        ...
                        value: function() {
                            ...
                            }), xt(this._element), this._element = null, this._dragPath = null, this._accept = null
                        }
                    }, {
                        key: "element",
                        get: function() {
                    ...
                    return l(e, [{
                        ...
                        value: function() {
                            ...
                            h(this._element, {
                                ...
                                duration: 500,
                                complete: function() {
                                    L(t._element), t._element.setAttribute("data-state", "off"), e()
                                }
                            })
                        }
                    }, {
            ...
            Dt = ["x", "y", "width", "height"],
            Rt = ["file-invalid-drop", "file-invalid", "file-drop", "file-over", "file-out", "click"],
            zt = ["cancel", "confirm"],
            ...
            qt = function() {
                ...
                return l(e, [{
                    ...
                    value: function(t, e) {
                        if ("number" == typeof t || t % 90 === 0) {
                            ...
                            if (this._data.input.image) {
                                ...
                                this._data.actions.crop = Z(n, o, this._ratio), this._data.actions.crop.type = Lt.AUTO
                            }
                    ...
                    key: "setSize",
                    value: function(t, e) {
                        "string" == typeof t && (t = Wt(t)), t && t.width && t.height && (this._options.size = pt(t), this._data.actions.size = pt(t), this._data.input.image && e && this._manualTransform(e))
                    }
                }, {
                    key: "setRatio",
                    value: function(t, e) {
                        ...
                        if (t && "string" == typeof t && (this._options.ratio = t, this._isFixedRatio())) {
                            ...
                            }) : (this._data.input.image && (this._data.actions.crop = Z(this._data.input.image.width, this._data.input.image.height, this._ratio), this._data.actions.crop.type = Lt.AUTO), this._scaleDropArea(this._ratio), e && e(null))
                        }
                    }
                }, {
                    key: "isAttachedTo",
                    ...
                    key: "_isAutoCrop",
                    value: function() {
                        return this._data.actions.crop.type === Lt.AUTO
                    }
                }, {
                    key: "_toggleButton",
                    value: function(t, e) {
                        wt('.slim-btn[data-action="' + t + '"]', e, this._element)
                    }
                }, {
                    key: "_clearState",
                    value: function() {
                    ...
                    key: "_addState",
                    value: function(t) {
                        I(t, this._state) || (this._state.push(t), this._updateState())
                    }
                }, {
                    key: "_updateState",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        if (this._element.appendChild(e), this._btnGroup = b("div", "slim-btn-group"), this._btnGroup.style.display = "none", this._element.appendChild(this._btnGroup), Bt.filter(function(e) {
                            ...
                            var s = It(this._options.ratio, ":");
                            this._ratio = s[1] / s[0], this._scaleDropArea(this._ratio)
                        }
                    ...
                    value: function() {
                        ...
                        this._options.saveInitialImage && null !== this._data.input.name ? this._options.service || this._save(function() {
                            e()
                        }, !1) : (this._options.service && null !== this._data.input.name && this._toggleButton("upload", !1), e())
                    }
                }, {
                    key: "_updateProgress",
                    value: function(t) {
                        if (t = Math.min(.99999, t), this._element && this._progressEnabled) {
                            ...
                            if (e) {
                                ...
                                n[0].setAttribute("d", Ct(.5 * i, .5 * i, .5 * i - o, .9999)), n[1].setAttribute("d", Ct(.5 * i, .5 * i, .5 * i - o, t))
                            }
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        e || (e = b("div", "slim-error"), this._element.querySelector(".slim-status").appendChild(e)), e.innerHTML = t
                    }
                }, {
                    key: "_removeError",
                    value: function() {
                    ...
                    value: function() {
                        var t = this._options.statusImageTooSmall.replace("$0", this._options.minSize.width + " Ãƒâ€” " + this._options.minSize.height);
                        this._throwError(t)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        var e = this._getDrip(),
                            i = h.createMatrix();
                        i.translate(t.detail.x, t.detail.y, 0), h.setElementTransform(e, i),
                            1 == this._imageHopper.dragPath.length && (e.style.opacity = 1, h(e.firstChild, {
                                fromOpacity: 0,
                                opacity: .5,
                                fromScale: [0, 0],
                                scale: [.5, .5],
                    ...
                    value: function(t, e) {
                        ...
                        if (!this._isBeingDestroyed) {
                            ...
                            if ("string" == typeof t) return void(G(t) ? this._load(J(t), e) : (n(), X(t, function(t) {
                                i._load(t, e)
                            })));
                            var r = t;
                            if (this._imageHopper && this._imageHopper.accept.indexOf(r.type) === -1) return o(), this._onInvalidFile(), void(e && e.apply(this, ["file-invalid"]));
                            if (r.size && this._options.maxFileSize && D(r.size) > this._options.maxFileSize) return o(), this._onOverWeightFile(), void(e && e.apply(this, ["file-too-big"]));
                            this._imageEditor && this._imageEditor.dirty(), this._data.input.name = W(r), this._data.input.type = q(r), this._data.input.size = r.size, this._data.input.file = r, $(r, this._options.internalCanvasSize, function(t, n) {
                                var o = function() {
                                ...
                                if (!t) return o(), void(e && e.apply(i, ["file-not-found"]));
                                if (!ut(t, i._options.minSize)) return o(), i._onImageTooSmall(), void(e && e.apply(i, ["image-too-small"]));
                                var s = i._options.didLoad.apply(i, [r, t, n]);
                                if (s !== !0) return o(), s !== !1 && i._throwError(s), void(e && e.apply(i, [s]));
                                ...
                                i._loadCanvas(t, function(t) {
                                    i._addState("preview"), a(function() {
                    ...
                    value: function(t, e, i) {
                        ...
                        if (!this._isBeingDestroyed) {
                            ...
                            var o = this._data.actions.rotation % 180 !== 0;
                            this._isFixedRatio() || (this._initialCrop ? this._ratio = this._initialCrop.height / this._initialCrop.width : this._ratio = o ? t.width / t.height : t.height / t.width, this._scaleDropArea(this._ratio)), this._initialCrop ? (this._data.actions.crop = pt(this._initialCrop), this._data.actions.crop.type = Lt.INITIAL, this._initialCrop = null) : (this._data.actions.crop = Z(o ? t.height : t.width, o ? t.width : t.height, this._ratio), this._data.actions.crop.type = Lt.AUTO), this._options.size && (this._data.actions.size = {
                                width: this._options.size.width,
                                height: this._options.size.height
                            }), this._applyTransforms(t, function(t) {
                                var o = n._getIntro(),
                                    r = o.offsetWidth / t.width,
                                    s = !1;
                                n._options.service && n._options.push && (n._hasInitialImage || n._canInstantEdit() || (s = !0, n._stopProgressLoop(function() {
                                    n._startProgress(function() {
                                        n._updateProgress(.1)
                                    })
                                }))), n._canInstantEdit() || n._save(function() {
                                    n._isBeingDestroyed || s && (n._stopProgress(), i())
                                }, s), o.src = "", o.src = rt(t, r).toDataURL(), o.onload = function() {
                                    o.onload = null, n._isBeingDestroyed || e && e(s)
                                }
                            })
                        }
                    }
                    ...
                    value: function(t, e) {
                        var i = this,
                            n = pt(this._data.actions);
                        n.filters = {
                            sharpen: this._options.filterSharpen / 100
                        }, K(t, n, function(t) {
                            var n = t;
                            if (i._options.forceSize || i._options.size && 1 == nt(i._options.size, t)) {
                    ...
                    value: function() {
                        var t = this;
                        this._imageEditor || (this._imageEditor = new Tt(b("div"), {
                    ...
                    value: function(t) {
                        ...
                        i ? this._startProgress(function() {
                            e._updateProgress(.1)
                        }) : this._startProgressLoop(), this._removeState("editor"), this._addState("busy"), this._output.value = "", this._data.actions.rotation = t.detail.rotation, this._data.actions.crop = t.detail.crop, this._data.actions.crop.type = Lt.MANUAL, this._applyTransforms(this._data.input.image, function(t) {
                            var n = e._getInOut(),
                                o = "out" === n[0].className ? n[0] : n[1],
                                r = o === n[0] ? n[1] : n[0];
                            o.className = "in", o.style.opacity = "0", o.style.zIndex = "2", r.className = "out", r.style.zIndex = "1", o.src = "", o.src = rt(t, o.offsetWidth / t.width).toDataURL(), o.onload = function() {
                    ...
                    value: function() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function(t) {},
                            ...
                            i = Z(e ? this._data.input.image.width : this._data.input.image.height, e ? this._data.input.image.height : this._data.input.image.width, this._ratio);
                        this._crop(i.x, i.y, i.width, i.height, t, Lt.AUTO)
                    }
                }, {
                    key: "_crop",
                    value: function(t, e, i, n) {
                        var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : function(t) {},
                            r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : Lt.MANUAL;
                    ...
                    value: function(t) {
                        ...
                        this._startProgressLoop(), this._addState("busy"), this._applyTransforms(this._data.input.image, function(i) {
                            var n = e._getInOut(),
                                o = "out" === n[0].className ? n[0] : n[1],
                                r = o === n[0] ? n[1] : n[0];
                            o.className = "in", o.style.opacity = "1", o.style.zIndex = "2", r.className = "out", r.style.zIndex = "0", o.src = "", o.src = rt(i, o.offsetWidth / i.width).toDataURL(), o.onload = function() {
                    ...
                    value: function() {
                        ...
                        if (!this._isBeingDestroyed) {
                            ...
                            }]), this._isBeingDestroyed || (this._options.service && i && this._options.willSave.apply(this, [n, function(i) {
                                t._addState("upload"), t._upload(i, function(n, o) {
                                    n || t._storeServerResponse(o), t._options.didUpload.apply(t, [n, i, o]), t._removeState("upload"), e(n, i, o)
                                })
                    ...
                    value: function(t, e) {
                        var i = this,
                            n = new FormData;
                        if (null !== this._data.output.image && this._options.uploadBase64 === !1) {
                            var o = J(t.output.image, t.output.name),
                                r = "slim_output_" + this._uid;
                            t.output.image = null, t.output.field = r, n.append(r, o, t.output.name)
                        }
                        n.append(this._output.name, JSON.stringify(t)), I("input", this._options.post) && n.append(this._inputReference, this._data.input.file, this._data.input.file.name);
                        var s = this._element.querySelector(".slim-upload-status"),
                            a = this._options.willRequest;
                        O(this._options.service, n, a, function(t, e) {
                            i._updateProgress(Math.max(.1, t / e))
                        }, function(t) {
                            var n = setTimeout(function() {
                                if (!i._isBeingDestroyed) {
                                    s.innerHTML = i._options.statusUploadSuccess, s.setAttribute("data-state", "success"), s.style.opacity = 1;
                                    var t = setTimeout(function() {
                                        s.style.opacity = 0
                                    }, 2e3);
                                    i._timers.push(t)
                            ...
                            var n = "";
                            n = "file-too-big" === t ? i._options.statusContentLength : i._options.didReceiveServerError.apply(i, [t, i._options.statusUnknownResponse]);
                            var o = setTimeout(function() {
                                s.innerHTML = n, s.setAttribute("data-state", "error"), s.style.opacity = 1
                            }, 250);
                            i._timers.push(o), e(t)
                        })
                    }
                }, {
                    key: "_showEditor",
                    value: function() {
                        Ut.show(), this._imageEditor.show()
                    }
                }, {
                    key: "_hideEditor",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        t && yt(this._data, this._options.jpegCompression, this._options.forceType)
                    }
                }, {
                    key: "_doDestroy",
                    value: function() {
                        ...
                        this._isBeingDestroyed = !0, this._timers.forEach(function(t) {
                            clearTimeout(t)
                        }), this._timers = [], h(this._element, "detach"), this._imageHopper && (Rt.forEach(function(t) {
                            e._imageHopper.element.removeEventListener(t, e)
                        }), this._imageHopper.destroy(), this._imageHopper = null), this._imageEditor && (zt.forEach(function(t) {
                            e._imageEditor.element.removeEventListener(t, e)
                        }), this._imageEditor.destroy(), this._imageEditor = null), bt(this._btnGroup.children).forEach(function(t) {
                        ...
                        }), Nt = Math.max(0, Nt - 1), Ut && 0 === Nt && (Ut.destroy(), Ut = null), this._originalElement = null, this._element = null, this._input = null, this._output = null, this._btnGroup = null, this._options = null
                    }
                }, {
                    key: "dataBase64",
                    get: function() {
                        return vt(this._data, this._options.post, this._options.jpegCompression, this._options.forceType)
                    }
                }, {
                    key: "data",
                    get: function() {
                        return _t(this._data)
                    }
                }, {
                    key: "element",
                    get: function() {
                    ...
                    value: function() {
                        var t = {
                            ...
                            rotateButton: !0,
                            label: "<p>Загрузите фото</p>",
                            labelLoading: "<p>Загрузка фото...</p>",
                        ...
                        return Bt.concat(Tt.Buttons).concat("rotate").forEach(function(e) {
                            var i = T(e);
        ...
        return function() {
            ...
            ["FileSize", "FileType", "NoSupport", "ImageTooSmall"].forEach(function(t) {
                ...
                f["status" + t] = o
            }), ["Init", "Load", "Save", "Upload", "Remove", "Transform", "ReceiveServerError"].forEach(function(t) {
                f["did" + t] = h
            }), ["Transform", "Save", "Remove", "Request"].forEach(function(t) {
                f["will" + t] = h
            });
            var _ = ["ClassName", "Label", "Title"];
            Bt.concat(Tt.Buttons).concat("rotate").forEach(function(t) {
                var e = T(t);
                ...
                var e, i, n, o = [];
                for (e = t.querySelectorAll(".slim:not([data-state])"), n = e.length; n--;) i = e[n], o.push(qt.create(i, qt.getOptionsFromAttributes(i)));
                return o
                ...
                for (var n in e) {
                    var o = f[n],
                        r = e[n];
                    o ? (r = o(r), r = null === r ? pt(qt.options()[n]) : r, i[n] = r) : 0 === n.indexOf("meta") && (i.meta[M(n.substr(4))] = r)
                }
                return i
            }, qt.find = function(t) {
        ...
        var e = function(e) {
            if (!t.supported) {
                ...
                return i.classList.remove("slim"), void(i.innerHTML = '<p class="slim-not-supported">This browser does not have the required features to support Slim.</p>')
            }
            t.parse(e)
        };
        return e
